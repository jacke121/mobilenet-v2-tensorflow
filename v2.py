...
class MobileNetV1(object):
    ...
    def _build_model(self):
        ...
        with tf.variable_scope('prediction'):
            self.output = tc.layers.conv2d(self.pool, 2, 1, activation_fn=None)
...
class MobileNetV2(object):
    ...
    def _build_model(self):
        ...
        self.output = tc.layers.conv2d(self.output, 2, 1, activation_fn=None)
